...
const NewsletterSection = () => {
  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-blush-400 via-blush-500 to-blush-600 relative overflow-hidden">
      {/* Background Pattern */}
        ...
        >
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-white/90">
            <div className="flex items-center justify-center gap-3">
              <svg className="w-5 h-5 text-gold-300" fill="currentColor" viewBox="0 0 24 24">
