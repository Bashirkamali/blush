...
const AboutSection = () => {
  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-white to-blush-50">
          ...
          <div className="relative group">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              ...
              <div className="absolute top-6 right-6 w-16 h-16 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg">
                <svg className="w-8 h-8 text-gold-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
